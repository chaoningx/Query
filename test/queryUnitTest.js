...
document.body.appendChild($('<div id="dom-test-3" style="position: absolute; top: 100px;left: 200px; margin: 10px 20px;"><div id="dom-test-2-1"></div></div>')[0]);
test('$.css()', function() {
    $('#dom-test-3').css({ top: '130px' });
    equal($.css('dom-test-3', 'position'), 'absolute', '单个样式取出成功')
    deepEqual($.css('dom-test-3', 'position', 'top', 'left', 'marginLeft'), {
        position: 'absolute',
        top: 130,
        left: 200,
        marginLeft: 20
